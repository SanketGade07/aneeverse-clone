      ...
      <div className="site-container">
        ...
        <div className="flex flex-wrap justify-center gap-8 mb-8">
          {cards.map((card, index) => (
            <div 
              key={index} 
              className="group bg-[#07242e] rounded-[32px] p-8 flex flex-col items-center border border-white/5 transition-all duration-300 hover:bg-[#072d38] cursor-pointer w-full md:w-[390.66px] h-auto md:h-[420.25px]"
            >
              <div className="mb-6 rounded-2xl overflow-hidden w-full flex justify-center">
                <img 
                  src={card.image} 
                  alt={card.title} 
                  className="w-full md:w-[326.66px] h-[220px] object-contain transition-transform duration-500" 
                />
              </div>
        ...
        <div className="flex flex-wrap justify-center gap-8">
          {/* Card 4 Text */}
          <div className="bg-[#07242e] rounded-[32px] p-8 md:p-12 border border-white/5 transition-all duration-300 hover:bg-[#072d38] cursor-pointer text-left w-full md:w-[496.33px] h-auto md:h-[364px] flex flex-col justify-center">
            <h3 className="text-white font-bw-gradual font-bold text-2xl md:text-3xl mb-6 leading-tight">
          ...
          <div className="bg-[#07242e] rounded-[32px] p-4 md:p-8 flex items-center justify-center border border-white/5 transition-all duration-300 hover:bg-[#072d38] cursor-pointer w-full md:w-[707.68px] h-auto md:h-[364px]">
            <div className="w-full h-full rounded-2xl overflow-hidden flex items-center justify-center">
              <img 
                src={card4Img} 
                alt="Final files delivered" 
                className="w-full md:w-[643.67px] h-[300px] object-contain transition-transform duration-500" 
              />
            </div>
          </div>
        </div>
